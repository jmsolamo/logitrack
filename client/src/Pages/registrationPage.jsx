        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:gap-3">
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="w-full px-3 py-2 text-sm bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-orange-600 transition placeholder-gray-500 text-gray-900"
              required
            />
            <input
              type="text"
