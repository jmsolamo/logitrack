...
function DriverExpenseBreakdown() {
  return (
    <div className="flex h-full items-center justify-center p-4">
      <div className="flex max-w-sm flex-col items-center text-center">
        ...
        <h1 className="mb-2 text-base font-bold tracking-tight text-foreground md:text-lg">
          Expenses Breakdown Coming Soon
        </h1>
        ...
        <div className="grid w-full grid-cols-2 gap-2 text-left">
          <div className="rounded-lg border border-border bg-muted/30 p-3">
            ...
            <div className="text-[11px] font-medium">Detailed Analysis</div>
          </div>
          <div className="rounded-lg border border-border bg-muted/30 p-3">
            <div className="mb-0.5 text-[9px] font-bold uppercase tracking-widest text-muted-foreground">
              Feature
            </div>
            <div className="text-[11px] font-medium">Driver Allotments</div>
          </div>
        </div>
      </div>
    </div>
...
export default DriverExpenseBreakdown;
